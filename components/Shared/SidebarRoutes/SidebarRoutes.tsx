...
import { BarChart,BarChart2,DoorClosed,House,Icon,RectangleEllipsis } from "lucide-react";
          ...
          <AccordionItem value="item-1" className='border-b-0'>
            ...
            <AccordionContent>
              {children.map(({item,href,icon:Icon,premium})=>(
                <div key={item} className='flex items-center justify-between mt-2 hover:bg-blue-100/2 duration-300 transition-all rounded-md pr-1'>
                  <Link
                  href={href}
